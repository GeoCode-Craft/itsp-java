...
import de.ifgi.itsp.task4.shapes.City;
...
public class Utility {
    ...
    public static List<City> getCityPointsFromFile(){
        ...
        //C:\Users\pondi\Desktop\itsp-java\JavaFinalProject4\src\main\java\de\ifgi\itsp\task4\europeancities.txt
        File cityDataFile = new File("src/de/ifgi/itsp/task4/europeancities.txt");
